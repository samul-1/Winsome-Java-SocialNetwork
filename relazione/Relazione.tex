...
di impossibilità di completare l'operazione (file inesistnete o malformato), restituisce una nuova istanza dello store.


\section{Il service layer}
Introduzione\\
\subsection{La classe SocialNetworkService}\quad \\
